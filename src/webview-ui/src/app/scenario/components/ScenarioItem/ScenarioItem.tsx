...
import { deleteScenario, updateScenario } from "@/app/scenario/helpers/scenarioMessage";
import { ScenarioActionType, type Scenario } from "@extension/types/scenario.type";
